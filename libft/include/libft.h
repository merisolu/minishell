...
/*   Updated: 2022/03/21 16:22:41 by jumanner         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned long long	ft_min_ullong(unsigned long long l1, unsigned long long l2);
...
int					ft_getdigits_ullong(unsigned long long c);
...
int					ft_getnumlen_ullong(unsigned long long c);
...
void				ft_path_join(char *p1, char *p2, char dst[PATH_MAX + 1]);
